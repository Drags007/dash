/* src/config/kliq-config.h.  Generated from kliq-config.h.in by configure.  */
/* src/config/kliq-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef KLIQ_CONFIG_H

#define KLIQ_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/kliqpay/kliq/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Kliq Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Kliq Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "kliqcore"
